        ...
        <div className="flex flex-col items-center justify-end relative size-full">
          <div className="box-border content-stretch flex flex-col gap-[74px] items-center justify-end px-4 sm:px-8 lg:px-[220px] py-12 relative size-full">
            <motion.div
              ...
              viewport={{ once: true }}
              className="box-border content-stretch flex flex-col font-['Saira_Condensed:Light',_sans-serif] items-center justify-center leading-[0] not-italic pt-0 px-0 relative shrink-0 text-[#ffffff] text-center w-full max-w-[560px]"
              data-name="Heading 2"
