...
// ----- App (gestor de escena principal) -----
...
const Hyperspeed = forwardRef(function Hyperspeed(props: HyperspeedProps, ref) {
  ...
  useEffect(() => {
    ...
    // ----- BLOQUE DISTORSIONES DENTRO DEL useEffect -----
    ...
    // Preparación de options con la distorsión elegida
    const options = { ...mergedOptions };
    if (typeof options.distortion === "string") {
      options.distortion = distortions[options.distortion as keyof typeof distortions];
    }

    // Instancia y montaje de la App ThreeJS
    const container = hyperspeed.current;
    if (!container) return;
    container.innerHTML = ""; // LIMPIA el div antes de crear el canvas
